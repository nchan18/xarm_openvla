...
@configclass
class XarmCubeLiftEnvCfg(joint_pos_env_cfg.XarmCubeLiftEnvCfg):
    def __post_init__(self):
        ...
        # Set actions for the specific robot type (Xarm)
...
@configclass
class XarmCubeLiftEnvCfg_PLAY(XarmCubeLiftEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
...
@configclass
class XarmTeddyBearLiftEnvCfg(XarmCubeLiftEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
